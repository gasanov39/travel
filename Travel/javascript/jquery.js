    ...
    function (C, e) {
        ...
        S.each([
            ...
            S.cssHooks[u] = {
                get: function (e, t, n) {
                    if (t) 
                        return !Ue.test(S.css(e, "display")) || e
                            .getClientRects()
                            .length && e
                ...
                set: function (e, t, n) {
                    var r,
                        ...
                        s = n
                            ...
                            : 0;
                    return a && o && (
                        s -= Math.ceil(e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - Qe(e, u, "border", !1, i) - .5)
                    ),
        ...
        S.cssHooks.marginLeft = Fe(y.reliableMarginLeft, function (e, t) {
            if (t) 
                return (
                    parseFloat(We(e, "marginLeft")) || e.getBoundingClientRect().left - Me(e, {
                        marginLeft: 0
                    }, function () {
                        return e
                            .getBoundingClientRect()
                ...
                var i,
                    ...
                    h = v.call(e, "namespace")
                        ? e
                            ...
                            .split(".")
                        : [];
                if (o = f = a = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !mt.test(
                    d + S.event.triggered
                ) && (
            ...
            ajax: function (e, t) {
                ...
                function l(e, t, n, r) {
                    ...
                    h || (
                        ...
                        !i && -1 < S.inArray("script", v.dataTypes) && S.inArray("json", v.dataTypes) < 0 && (
